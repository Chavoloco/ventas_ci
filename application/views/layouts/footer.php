...
$(document).ready(function () {
    ...
    $(".btn-view-cliente").on("click", function(){
        ...
        html += "<p><strong>Domicilio:</strong>"+" "+infocliente[3]+"</p>"
        html += "<p><strong>Teléfono:</strong>"+" "+infocliente[4]+"</p>"
    ...
    $(".btn-view-proveedor").on("click", function(){
        ...
        html = "<p><strong>Id:</strong>"+" "+infoproveedor[0]+"</p>"
        html = "<p><strong>Nombre:</strong>"+" "+infoproveedor[1]+"</p>"
        html += "<p><strong>Razon Social:</strong>"+" "+infoproveedor[2]+"</p>"
        html += "<p><strong>CUIT:</strong>"+" "+infoproveedor[3]+"</p>"
